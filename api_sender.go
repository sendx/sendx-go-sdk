...
type ApiCreateSenderRequest struct {
	...
	restESender *RestESender
}

func (r ApiCreateSenderRequest) RestESender(restESender RestESender) ApiCreateSenderRequest {
	r.restESender = &restESender
	return r
}

func (r ApiCreateSenderRequest) Execute() (*RestRSender, *http.Response, error) {
...
//  @return RestRSender
func (a *SenderAPIService) CreateSenderExecute(r ApiCreateSenderRequest) (*RestRSender, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RestRSender
	)
	...
	if r.restESender == nil {
		return localVarReturnValue, nil, reportError("restESender is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.restESender
	if r.ctx != nil {
...
func (r ApiGetAllSendersRequest) Execute() ([]RestRSender, *http.Response, error) {
...
// Execute executes the request
//  @return []RestRSender
func (a *SenderAPIService) GetAllSendersExecute(r ApiGetAllSendersRequest) ([]RestRSender, *http.Response, error) {
	var (
