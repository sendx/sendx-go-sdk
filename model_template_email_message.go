...
// checks if the TemplateEmailMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateEmailMessage{}

// TemplateEmailMessage struct for TemplateEmailMessage
...
type _TemplateEmailMessage TemplateEmailMessage
...
func (o TemplateEmailMessage) MarshalJSON() ([]byte, error) {
...
func (o TemplateEmailMessage) ToMap() (map[string]interface{}, error) {
...
func (o *TemplateEmailMessage) UnmarshalJSON(data []byte) (err error) {
	...
	varTemplateEmailMessage := _TemplateEmailMessage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTemplateEmailMessage)

	if err != nil {
		return err
	}

	*o = TemplateEmailMessage(varTemplateEmailMessage)

	return err
}

type NullableTemplateEmailMessage struct {
	value *TemplateEmailMessage
	isSet bool
}

func (v NullableTemplateEmailMessage) Get() *TemplateEmailMessage {
	return v.value
}

func (v *NullableTemplateEmailMessage) Set(val *TemplateEmailMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateEmailMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateEmailMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateEmailMessage(val *TemplateEmailMessage) *NullableTemplateEmailMessage {
	return &NullableTemplateEmailMessage{value: val, isSet: true}
}

func (v NullableTemplateEmailMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateEmailMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
