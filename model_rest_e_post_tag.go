...
// checks if the RestEPostTag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestEPostTag{}

// RestEPostTag struct for RestEPostTag
type RestEPostTag struct {
	// Tag name
	Name string `json:"name"`
}

type _RestEPostTag RestEPostTag
...
func (o RestEPostTag) MarshalJSON() ([]byte, error) {
...
func (o RestEPostTag) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	return toSerialize, nil
}

func (o *RestEPostTag) UnmarshalJSON(data []byte) (err error) {
	...
	varRestEPostTag := _RestEPostTag{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestEPostTag)

	if err != nil {
		return err
	}

	*o = RestEPostTag(varRestEPostTag)

	return err
}

type NullableRestEPostTag struct {
	value *RestEPostTag
	isSet bool
}

func (v NullableRestEPostTag) Get() *RestEPostTag {
	return v.value
}

func (v *NullableRestEPostTag) Set(val *RestEPostTag) {
	v.value = val
	v.isSet = true
}

func (v NullableRestEPostTag) IsSet() bool {
	return v.isSet
}

func (v *NullableRestEPostTag) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestEPostTag(val *RestEPostTag) *NullableRestEPostTag {
	return &NullableRestEPostTag{value: val, isSet: true}
}

func (v NullableRestEPostTag) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestEPostTag) UnmarshalJSON(src []byte) error {
	v.isSet = true
