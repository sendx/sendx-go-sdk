...
// checks if the PostbackResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostbackResponse{}

// PostbackResponse struct for PostbackResponse
...
func (o PostbackResponse) MarshalJSON() ([]byte, error) {
...
func (o PostbackResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePostbackResponse struct {
	value *PostbackResponse
	isSet bool
}

func (v NullablePostbackResponse) Get() *PostbackResponse {
	return v.value
}

func (v *NullablePostbackResponse) Set(val *PostbackResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePostbackResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePostbackResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostbackResponse(val *PostbackResponse) *NullablePostbackResponse {
	return &NullablePostbackResponse{value: val, isSet: true}
}

func (v NullablePostbackResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostbackResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
