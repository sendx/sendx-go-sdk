...
// checks if the XFrom type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &XFrom{}

// XFrom struct for XFrom
type XFrom struct {
...
func (o XFrom) MarshalJSON() ([]byte, error) {
...
func (o XFrom) ToMap() (map[string]interface{}, error) {
...
func (o *XFrom) UnmarshalJSON(data []byte) (err error) {
...
type NullableXFrom struct {
	value *XFrom
	isSet bool
}

func (v NullableXFrom) Get() *XFrom {
	return v.value
}

func (v *NullableXFrom) Set(val *XFrom) {
	v.value = val
	v.isSet = true
}

func (v NullableXFrom) IsSet() bool {
	return v.isSet
}

func (v *NullableXFrom) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXFrom(val *XFrom) *NullableXFrom {
	return &NullableXFrom{value: val, isSet: true}
}

func (v NullableXFrom) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXFrom) UnmarshalJSON(src []byte) error {
	v.isSet = true
