...
type ApiEventsCustomPostbackGetRequest struct {
	ctx context.Context
...
func (r ApiEventsCustomPostbackGetRequest) TeamId(teamId string) ApiEventsCustomPostbackGetRequest {
	r.teamId = &teamId
	return r
}

// The unique sendx identifier for the contact/customer.
func (r ApiEventsCustomPostbackGetRequest) Id(id string) ApiEventsCustomPostbackGetRequest {
	r.id = &id
	return r
}

// The custom event name.
func (r ApiEventsCustomPostbackGetRequest) Event(event string) ApiEventsCustomPostbackGetRequest {
	r.event = &event
	return r
}
...
func (r ApiEventsCustomPostbackGetRequest) AnyKey(anyKey string) ApiEventsCustomPostbackGetRequest {
	r.anyKey = &anyKey
	return r
}

func (r ApiEventsCustomPostbackGetRequest) Execute() (*EventsRevenuePostbackGet200Response, *http.Response, error) {
	return r.ApiService.EventsCustomPostbackGetExecute(r)
}

/*
EventsCustomPostbackGet Custom Event Postback URL

Register a custom event for a specific team and event.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiEventsCustomPostbackGetRequest
*/
func (a *EventAPIService) EventsCustomPostbackGet(ctx context.Context) ApiEventsCustomPostbackGetRequest {
	return ApiEventsCustomPostbackGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *EventAPIService) EventsCustomPostbackGetExecute(r ApiEventsCustomPostbackGetRequest) (*EventsRevenuePostbackGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EventsRevenuePostbackGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EventAPIService.EventsCustomPostbackGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/events/custom/postback"
	...
	if r.anyKey == nil {
		return localVarReturnValue, nil, reportError("anyKey is required and must be specified")
	}
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "any-key", r.anyKey, "form", "")
...
type ApiEventsRevenuePostbackGetRequest struct {
	ctx context.Context
	ApiService *EventAPIService
	teamId *string
	id *string
...
// The unique identifier for the team.
func (r ApiEventsRevenuePostbackGetRequest) TeamId(teamId string) ApiEventsRevenuePostbackGetRequest {
	r.teamId = &teamId
	return r
}

// The unique sendx identifier for the contact/customer.
func (r ApiEventsRevenuePostbackGetRequest) Id(id string) ApiEventsRevenuePostbackGetRequest {
	r.id = &id
	return r
}

// The revenue amount to be posted back.
func (r ApiEventsRevenuePostbackGetRequest) Amount(amount float32) ApiEventsRevenuePostbackGetRequest {
	r.amount = &amount
	return r
}

// The unique identifier for the campaign.
func (r ApiEventsRevenuePostbackGetRequest) CampaignId(campaignId string) ApiEventsRevenuePostbackGetRequest {
	r.campaignId = &campaignId
	return r
}

func (r ApiEventsRevenuePostbackGetRequest) Execute() (*EventsRevenuePostbackGet200Response, *http.Response, error) {
	return r.ApiService.EventsRevenuePostbackGetExecute(r)
}

/*
EventsRevenuePostbackGet Revenue Event Postback URL

Trigger a revenue postback for a specific team and event.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiEventsRevenuePostbackGetRequest
*/
func (a *EventAPIService) EventsRevenuePostbackGet(ctx context.Context) ApiEventsRevenuePostbackGetRequest {
	return ApiEventsRevenuePostbackGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return EventsRevenuePostbackGet200Response
func (a *EventAPIService) EventsRevenuePostbackGetExecute(r ApiEventsRevenuePostbackGetRequest) (*EventsRevenuePostbackGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EventAPIService.EventsRevenuePostbackGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/events/revenue/postback"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v EventsRevenuePostbackGet400Response
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v EventsRevenuePostbackGet500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
