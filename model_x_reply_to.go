...
// checks if the XReplyTo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &XReplyTo{}

// XReplyTo struct for XReplyTo
type XReplyTo struct {
	Email string `json:"email"`
	Name *string `json:"name,omitempty"`
}

type _XReplyTo XReplyTo
...
func (o XReplyTo) MarshalJSON() ([]byte, error) {
...
func (o XReplyTo) ToMap() (map[string]interface{}, error) {
...
func (o *XReplyTo) UnmarshalJSON(data []byte) (err error) {
	...
	varXReplyTo := _XReplyTo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varXReplyTo)

	if err != nil {
		return err
	}

	*o = XReplyTo(varXReplyTo)

	return err
}

type NullableXReplyTo struct {
	value *XReplyTo
	isSet bool
}

func (v NullableXReplyTo) Get() *XReplyTo {
	return v.value
}

func (v *NullableXReplyTo) Set(val *XReplyTo) {
	v.value = val
	v.isSet = true
}

func (v NullableXReplyTo) IsSet() bool {
	return v.isSet
}

func (v *NullableXReplyTo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXReplyTo(val *XReplyTo) *NullableXReplyTo {
	return &NullableXReplyTo{value: val, isSet: true}
}

func (v NullableXReplyTo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXReplyTo) UnmarshalJSON(src []byte) error {
	v.isSet = true
