...
func NewDeleteResponse(status string, message string) *DeleteResponse {
	this := DeleteResponse{}
	this.Status = status
...
func (o *DeleteResponse) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DeleteResponse) SetStatus(v string) {
	o.Status = v
}
