...
func NewRevenueEventRequest(identifier string, amount float32) *RevenueEventRequest {
...
func (o *RevenueEventRequest) HasSource() bool {
	if o != nil && !IsNil(o.Source) {
		return true
	}
...
func (o *RevenueEventRequest) GetTime() int64 {
...
// and a boolean to check if the value has been set.
func (o *RevenueEventRequest) GetTimeOk() (*int64, bool) {
	if o == nil || IsNil(o.Time) {
		return nil, false
	}
	return o.Time, true
...
func (o *RevenueEventRequest) HasTime() bool {
	if o != nil && !IsNil(o.Time) {
		return true
	}
...
func (o *RevenueEventRequest) SetTime(v int64) {
	o.Time = &v
}
