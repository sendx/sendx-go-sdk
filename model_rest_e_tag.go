...
// checks if the RestETag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestETag{}

// RestETag struct for RestETag
type RestETag struct {
	// Tag name (must be unique within team)
	Name string `json:"name"`
}

type _RestETag RestETag
...
func (o RestETag) MarshalJSON() ([]byte, error) {
...
func (o RestETag) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	return toSerialize, nil
}

func (o *RestETag) UnmarshalJSON(data []byte) (err error) {
	...
	varRestETag := _RestETag{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestETag)

	if err != nil {
		return err
	}

	*o = RestETag(varRestETag)

	return err
}

type NullableRestETag struct {
	value *RestETag
	isSet bool
}

func (v NullableRestETag) Get() *RestETag {
	return v.value
}

func (v *NullableRestETag) Set(val *RestETag) {
	v.value = val
	v.isSet = true
}

func (v NullableRestETag) IsSet() bool {
	return v.isSet
}

func (v *NullableRestETag) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestETag(val *RestETag) *NullableRestETag {
	return &NullableRestETag{value: val, isSet: true}
}

func (v NullableRestETag) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestETag) UnmarshalJSON(src []byte) error {
	v.isSet = true
