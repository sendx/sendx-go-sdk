...
// checks if the RestEPostCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestEPostCategory{}

// RestEPostCategory struct for RestEPostCategory
type RestEPostCategory struct {
	// Category name
	Name string `json:"name"`
}

type _RestEPostCategory RestEPostCategory
...
func (o RestEPostCategory) MarshalJSON() ([]byte, error) {
...
func (o RestEPostCategory) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	return toSerialize, nil
}

func (o *RestEPostCategory) UnmarshalJSON(data []byte) (err error) {
	...
	varRestEPostCategory := _RestEPostCategory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestEPostCategory)

	if err != nil {
		return err
	}

	*o = RestEPostCategory(varRestEPostCategory)

	return err
}

type NullableRestEPostCategory struct {
	value *RestEPostCategory
	isSet bool
}

func (v NullableRestEPostCategory) Get() *RestEPostCategory {
	return v.value
}

func (v *NullableRestEPostCategory) Set(val *RestEPostCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableRestEPostCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableRestEPostCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestEPostCategory(val *RestEPostCategory) *NullableRestEPostCategory {
	return &NullableRestEPostCategory{value: val, isSet: true}
}

func (v NullableRestEPostCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestEPostCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
