...
func (r ApiCreateListRequest) RestEList(restEList RestEList) ApiCreateListRequest {
	r.restEList = &restEList
	return r
}

func (r ApiCreateListRequest) Execute() (*RestRList, *http.Response, error) {
...
//  @return RestRList
func (a *ListAPIService) CreateListExecute(r ApiCreateListRequest) (*RestRList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RestRList
	)
	...
	if r.restEList == nil {
		return localVarReturnValue, nil, reportError("restEList is required and must be specified")
	}
...
Deletes a list.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param identifier List identifier to delete
 @return ApiDeleteListRequest
*/
func (a *ListAPIService) DeleteList(ctx context.Context, identifier string) ApiDeleteListRequest {
	return ApiDeleteListRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ListAPIService) DeleteListExecute(r ApiDeleteListRequest) (*DeleteResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/list/{identifier}"
...
func (r ApiGetAllListsRequest) Execute() ([]RestRList, *http.Response, error) {
...
// Execute executes the request
//  @return []RestRList
func (a *ListAPIService) GetAllListsExecute(r ApiGetAllListsRequest) ([]RestRList, *http.Response, error) {
	var (
...
func (r ApiGetListRequest) Execute() (*RestRList, *http.Response, error) {
...
Retrieves detailed information about a specific list.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param identifier List identifier - `list_OcuxJHdiAvujmwQVJfd3ss` 
 @return ApiGetListRequest
*/
func (a *ListAPIService) GetList(ctx context.Context, identifier string) ApiGetListRequest {
	return ApiGetListRequest{
		ApiService: a,
		ctx: ctx,
		identifier: identifier,
...
// Execute executes the request
//  @return RestRList
func (a *ListAPIService) GetListExecute(r ApiGetListRequest) (*RestRList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ListAPIService.GetList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateListRequest) RestEList(restEList RestEList) ApiUpdateListRequest {
	r.restEList = &restEList
	return r
}

func (r ApiUpdateListRequest) Execute() (*RestRList, *http.Response, error) {
...
Updates an existing list's settings.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param identifier List identifier to update
 @return ApiUpdateListRequest
*/
func (a *ListAPIService) UpdateList(ctx context.Context, identifier string) ApiUpdateListRequest {
	return ApiUpdateListRequest{
		ApiService: a,
		ctx: ctx,
		identifier: identifier,
...
// Execute executes the request
//  @return RestRList
func (a *ListAPIService) UpdateListExecute(r ApiUpdateListRequest) (*RestRList, *http.Response, error) {
	var (
