...
// checks if the RestRTag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestRTag{}

// RestRTag struct for RestRTag
type RestRTag struct {
	// Unique tag identifier with tag_ prefix
	Id *string `json:"id,omitempty" validate:"regexp=^tag_[a-zA-Z0-9]{22}$"`
	// Tag name
...
func (o RestRTag) MarshalJSON() ([]byte, error) {
...
func (o RestRTag) ToMap() (map[string]interface{}, error) {
...
type NullableRestRTag struct {
	value *RestRTag
	isSet bool
}

func (v NullableRestRTag) Get() *RestRTag {
	return v.value
}

func (v *NullableRestRTag) Set(val *RestRTag) {
	v.value = val
	v.isSet = true
}

func (v NullableRestRTag) IsSet() bool {
	return v.isSet
}

func (v *NullableRestRTag) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestRTag(val *RestRTag) *NullableRestRTag {
	return &NullableRestRTag{value: val, isSet: true}
}

func (v NullableRestRTag) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestRTag) UnmarshalJSON(src []byte) error {
	v.isSet = true
