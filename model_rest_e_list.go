...
// checks if the RestEList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestEList{}

// RestEList struct for RestEList
type RestEList struct {
	// List name
	Name string `json:"name"`
}

type _RestEList RestEList
...
func (o RestEList) MarshalJSON() ([]byte, error) {
...
func (o RestEList) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	return toSerialize, nil
}

func (o *RestEList) UnmarshalJSON(data []byte) (err error) {
	...
	varRestEList := _RestEList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestEList)

	if err != nil {
		return err
	}

	*o = RestEList(varRestEList)

	return err
}

type NullableRestEList struct {
	value *RestEList
	isSet bool
}

func (v NullableRestEList) Get() *RestEList {
	return v.value
}

func (v *NullableRestEList) Set(val *RestEList) {
	v.value = val
	v.isSet = true
}

func (v NullableRestEList) IsSet() bool {
	return v.isSet
}

func (v *NullableRestEList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestEList(val *RestEList) *NullableRestEList {
	return &NullableRestEList{value: val, isSet: true}
}

func (v NullableRestEList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestEList) UnmarshalJSON(src []byte) error {
	v.isSet = true
