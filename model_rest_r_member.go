...
// checks if the RestRMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestRMember{}

// RestRMember struct for RestRMember
type RestRMember struct {
...
func (o RestRMember) MarshalJSON() ([]byte, error) {
...
func (o RestRMember) ToMap() (map[string]interface{}, error) {
...
type NullableRestRMember struct {
	value *RestRMember
	isSet bool
}

func (v NullableRestRMember) Get() *RestRMember {
	return v.value
}

func (v *NullableRestRMember) Set(val *RestRMember) {
	v.value = val
	v.isSet = true
}

func (v NullableRestRMember) IsSet() bool {
	return v.isSet
}

func (v *NullableRestRMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestRMember(val *RestRMember) *NullableRestRMember {
	return &NullableRestRMember{value: val, isSet: true}
}

func (v NullableRestRMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestRMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
