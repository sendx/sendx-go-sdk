...
// checks if the RestETemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestETemplate{}

// RestETemplate struct for RestETemplate
type RestETemplate struct {
	// Template name
...
type _RestETemplate RestETemplate
...
func (o RestETemplate) MarshalJSON() ([]byte, error) {
...
func (o RestETemplate) ToMap() (map[string]interface{}, error) {
...
func (o *RestETemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varRestETemplate := _RestETemplate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestETemplate)

	if err != nil {
		return err
	}

	*o = RestETemplate(varRestETemplate)

	return err
}

type NullableRestETemplate struct {
	value *RestETemplate
	isSet bool
}

func (v NullableRestETemplate) Get() *RestETemplate {
	return v.value
}

func (v *NullableRestETemplate) Set(val *RestETemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableRestETemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableRestETemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestETemplate(val *RestETemplate) *NullableRestETemplate {
	return &NullableRestETemplate{value: val, isSet: true}
}

func (v NullableRestETemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestETemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
