...
// checks if the RestRList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestRList{}

// RestRList struct for RestRList
type RestRList struct {
	Id *string `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
	// List type.  **Values:** - `0` - Regular list (single opt-in) - `1` - Double opt-in list (requires email confirmation) 
...
func (o RestRList) MarshalJSON() ([]byte, error) {
...
func (o RestRList) ToMap() (map[string]interface{}, error) {
...
type NullableRestRList struct {
	value *RestRList
	isSet bool
}

func (v NullableRestRList) Get() *RestRList {
	return v.value
}

func (v *NullableRestRList) Set(val *RestRList) {
	v.value = val
	v.isSet = true
}

func (v NullableRestRList) IsSet() bool {
	return v.isSet
}

func (v *NullableRestRList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestRList(val *RestRList) *NullableRestRList {
	return &NullableRestRList{value: val, isSet: true}
}

func (v NullableRestRList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestRList) UnmarshalJSON(src []byte) error {
	v.isSet = true
