...
// TeamMemberAPIService TeamMemberAPI service
type TeamMemberAPIService service

type ApiGetAllTeamMembersRequest struct {
	ctx context.Context
	ApiService *TeamMemberAPIService
}

func (r ApiGetAllTeamMembersRequest) Execute() ([]RestRMember, *http.Response, error) {
	return r.ApiService.GetAllTeamMembersExecute(r)
}
...
Retrieves all team members.
 ...
 @return ApiGetAllTeamMembersRequest
*/
func (a *TeamMemberAPIService) GetAllTeamMembers(ctx context.Context) ApiGetAllTeamMembersRequest {
	return ApiGetAllTeamMembersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []RestRMember
func (a *TeamMemberAPIService) GetAllTeamMembersExecute(r ApiGetAllTeamMembersRequest) ([]RestRMember, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []RestRMember
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamMemberAPIService.GetAllTeamMembers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/team/member"
...
func (r ApiGetTeamMemberRequest) Execute() (*RestRMember, *http.Response, error) {
	return r.ApiService.GetTeamMemberExecute(r)
}

/*
GetTeamMember Get a team member by ID
...
*/
func (a *TeamMemberAPIService) GetTeamMember(ctx context.Context, identifier string) ApiGetTeamMemberRequest {
	return ApiGetTeamMemberRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return RestRMember
func (a *TeamMemberAPIService) GetTeamMemberExecute(r ApiGetTeamMemberRequest) (*RestRMember, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamMemberAPIService.GetTeamMember")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/team/member/{identifier}"
