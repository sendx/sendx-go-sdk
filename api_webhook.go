...
func (r ApiCreateWebhookRequest) RestEWebhook(restEWebhook RestEWebhook) ApiCreateWebhookRequest {
	r.restEWebhook = &restEWebhook
	return r
}

func (r ApiCreateWebhookRequest) Execute() (*RestRWebhook, *http.Response, error) {
...
//  @return RestRWebhook
func (a *WebhookAPIService) CreateWebhookExecute(r ApiCreateWebhookRequest) (*RestRWebhook, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RestRWebhook
	)
	...
	if r.restEWebhook == nil {
		return localVarReturnValue, nil, reportError("restEWebhook is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.restEWebhook
	if r.ctx != nil {
...
- Clean up endpoints
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param identifier Webhook identifier to update
 @return ApiDeleteWebhookRequest
*/
func (a *WebhookAPIService) DeleteWebhook(ctx context.Context, identifier string) ApiDeleteWebhookRequest {
	return ApiDeleteWebhookRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *WebhookAPIService) DeleteWebhookExecute(r ApiDeleteWebhookRequest) (*DeleteResponse, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/webhook/{identifier}"
...
func (r ApiGetAllWebhooksRequest) Execute() ([]RestRWebhook, *http.Response, error) {
	return r.ApiService.GetAllWebhooksExecute(r)
}
...
*/
func (a *WebhookAPIService) GetAllWebhooks(ctx context.Context) ApiGetAllWebhooksRequest {
	return ApiGetAllWebhooksRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []RestRWebhook
func (a *WebhookAPIService) GetAllWebhooksExecute(r ApiGetAllWebhooksRequest) ([]RestRWebhook, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhookAPIService.GetAllWebhooks")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetWebhookRequest) Execute() (*RestRWebhook, *http.Response, error) {
...
Retrieves details about a specific webhook.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param identifier Webhook identifier to retrieve
 @return ApiGetWebhookRequest
*/
func (a *WebhookAPIService) GetWebhook(ctx context.Context, identifier string) ApiGetWebhookRequest {
	return ApiGetWebhookRequest{
		ApiService: a,
		ctx: ctx,
		identifier: identifier,
...
// Execute executes the request
//  @return RestRWebhook
func (a *WebhookAPIService) GetWebhookExecute(r ApiGetWebhookRequest) (*RestRWebhook, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateWebhookRequest) RestEWebhook(restEWebhook RestEWebhook) ApiUpdateWebhookRequest {
	r.restEWebhook = &restEWebhook
	return r
}

func (r ApiUpdateWebhookRequest) Execute() (*RestRWebhook, *http.Response, error) {
...
*/
func (a *WebhookAPIService) UpdateWebhook(ctx context.Context, identifier string) ApiUpdateWebhookRequest {
	return ApiUpdateWebhookRequest{
		ApiService: a,
		ctx: ctx,
		identifier: identifier,
...
// Execute executes the request
//  @return RestRWebhook
func (a *WebhookAPIService) UpdateWebhookExecute(r ApiUpdateWebhookRequest) (*RestRWebhook, *http.Response, error) {
	var (
