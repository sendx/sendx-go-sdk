...
// checks if the RestRPostCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestRPostCategory{}

// RestRPostCategory struct for RestRPostCategory
type RestRPostCategory struct {
...
func (o RestRPostCategory) MarshalJSON() ([]byte, error) {
...
func (o RestRPostCategory) ToMap() (map[string]interface{}, error) {
...
type NullableRestRPostCategory struct {
	value *RestRPostCategory
	isSet bool
}

func (v NullableRestRPostCategory) Get() *RestRPostCategory {
	return v.value
}

func (v *NullableRestRPostCategory) Set(val *RestRPostCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableRestRPostCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableRestRPostCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestRPostCategory(val *RestRPostCategory) *NullableRestRPostCategory {
	return &NullableRestRPostCategory{value: val, isSet: true}
}

func (v NullableRestRPostCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestRPostCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
