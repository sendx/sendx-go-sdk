...
// checks if the RestRCustomField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestRCustomField{}

// RestRCustomField struct for RestRCustomField
type RestRCustomField struct {
	// Unique field identifier with field_ prefix
	Id *string `json:"id,omitempty" validate:"regexp=^custom_field_[a-zA-Z0-9]{22}$"`
	// Custom field name
...
func (o RestRCustomField) MarshalJSON() ([]byte, error) {
...
func (o RestRCustomField) ToMap() (map[string]interface{}, error) {
...
type NullableRestRCustomField struct {
	value *RestRCustomField
	isSet bool
}

func (v NullableRestRCustomField) Get() *RestRCustomField {
	return v.value
}

func (v *NullableRestRCustomField) Set(val *RestRCustomField) {
	v.value = val
	v.isSet = true
}

func (v NullableRestRCustomField) IsSet() bool {
	return v.isSet
}

func (v *NullableRestRCustomField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestRCustomField(val *RestRCustomField) *NullableRestRCustomField {
	return &NullableRestRCustomField{value: val, isSet: true}
}

func (v NullableRestRCustomField) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestRCustomField) UnmarshalJSON(src []byte) error {
	v.isSet = true
