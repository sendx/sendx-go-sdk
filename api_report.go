...
func (r ApiGetCampaignReportRequest) Execute() (*RestReportData, *http.Response, error) {
...
*/
func (a *ReportAPIService) GetCampaignReport(ctx context.Context, identifier string) ApiGetCampaignReportRequest {
	return ApiGetCampaignReportRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return RestReportData
func (a *ReportAPIService) GetCampaignReportExecute(r ApiGetCampaignReportRequest) (*RestReportData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RestReportData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportAPIService.GetCampaignReport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/report/campaign/{identifier}"
