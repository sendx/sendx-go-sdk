...
*/
func (a *TrackingAPIService) IdentifyContact(ctx context.Context) ApiIdentifyContactRequest {
	return ApiIdentifyContactRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TrackingAPIService) IdentifyContactExecute(r ApiIdentifyContactRequest) (*IdentifyResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TrackingAPIService.IdentifyContact")
	if err != nil {
...
type ApiTrackContactRequest struct {
	ctx context.Context
	ApiService *TrackingAPIService
	trackRequest *TrackRequest
}

func (r ApiTrackContactRequest) TrackRequest(trackRequest TrackRequest) ApiTrackContactRequest {
	r.trackRequest = &trackRequest
	return r
}

func (r ApiTrackContactRequest) Execute() (*TrackResponse, *http.Response, error) {
	return r.ApiService.TrackContactExecute(r)
}
...
- Track user behavior
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiTrackContactRequest
*/
func (a *TrackingAPIService) TrackContact(ctx context.Context) ApiTrackContactRequest {
	return ApiTrackContactRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TrackingAPIService) TrackContactExecute(r ApiTrackContactRequest) (*TrackResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TrackingAPIService.TrackContact")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
