...
// checks if the XAttachment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &XAttachment{}

// XAttachment struct for XAttachment
type XAttachment struct {
	Filename string `json:"filename"`
	Content string `json:"content"`
}

type _XAttachment XAttachment
...
func (o XAttachment) MarshalJSON() ([]byte, error) {
...
func (o XAttachment) ToMap() (map[string]interface{}, error) {
...
func (o *XAttachment) UnmarshalJSON(data []byte) (err error) {
	...
	varXAttachment := _XAttachment{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varXAttachment)

	if err != nil {
		return err
	}

	*o = XAttachment(varXAttachment)

	return err
}

type NullableXAttachment struct {
	value *XAttachment
	isSet bool
}

func (v NullableXAttachment) Get() *XAttachment {
	return v.value
}

func (v *NullableXAttachment) Set(val *XAttachment) {
	v.value = val
	v.isSet = true
}

func (v NullableXAttachment) IsSet() bool {
	return v.isSet
}

func (v *NullableXAttachment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXAttachment(val *XAttachment) *NullableXAttachment {
	return &NullableXAttachment{value: val, isSet: true}
}

func (v NullableXAttachment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXAttachment) UnmarshalJSON(src []byte) error {
	v.isSet = true
