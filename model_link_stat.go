...
// checks if the LinkStat type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkStat{}
...
func (o LinkStat) MarshalJSON() ([]byte, error) {
...
func (o LinkStat) ToMap() (map[string]interface{}, error) {
...
type NullableLinkStat struct {
	value *LinkStat
	isSet bool
}

func (v NullableLinkStat) Get() *LinkStat {
	return v.value
}

func (v *NullableLinkStat) Set(val *LinkStat) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkStat) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkStat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkStat(val *LinkStat) *NullableLinkStat {
	return &NullableLinkStat{value: val, isSet: true}
}

func (v NullableLinkStat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkStat) UnmarshalJSON(src []byte) error {
	v.isSet = true
